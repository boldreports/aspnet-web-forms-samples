        ...
        <ul>
            ...
            <li>Sorting is applied to row groups to sort the product category and sub-category in descending and
                ...
                orders. More information about sorting data in matrix groups can be found in this <a
                    href="https://documentation.boldreports.com/on-premise/report-designer/report-items/tablix/sort-data-in-tablix-data-region/#set-sort-expression-on-a-tablix-group"
                    target="_blank">documentation</a> section.
            </li>
        </ul>
        <p>
            Company Sales report designing steps can be found in this <a
                href="https://documentation.boldreports.com/on-premise/report-designer/report-items/matrix/design-ssrs-matrix-report/#format-matrix-design"
                target="_blank">documentation</a> section.
        </p>
    </div>
