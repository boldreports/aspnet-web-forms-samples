...
<asp:content ID="descriptionContent" ContentPlaceHolderID="description" runat="server">
       ...
       <div id="description">
        <p>
            This demos allows you to view the product catalog <b>RDLC</b> that exist on the <code>local</code> file system with JSON array and custom business object data collection.
        </p>
        <p>
            More information about RDLC report can be found in this <a href="https://documentation.boldreports.com/home/" target="_blank">documentation</a> section.
        </p>
    </div>
